...
public class ClientGameManager: NetworkBehaviour{
    ...
    [ClientRpc]
    internal void GameStateChangeCallbackClientRpc(string strKey, int score, GameStateChangeCallbackID id){
        ...
        switch(id){
            ...
            case GameStateChangeCallbackID.OnScoreChange:
                this.OnScoreChange?.Invoke(this, new ScoreChangeEventArgs(score));
                break;
        }
    }
